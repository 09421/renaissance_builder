...
export const characters: UnitDefinition[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'general', name: 'General', points: 0, category:'general', isFixedCost:true },
      { id: 'steed', name: 'Elven Steed', points: 20, group: 'mount', optionProfile: [{ name: 'Elven Steed', stats: HE_STATS.elvenSteed }], category:'mount', isFixedCost:true },
      { id: 'barding', name: 'Barding', points: 0, requires: ['steed'], category:'mount', isFixedCost:true },
      { id: 'Tiranoc_chariot', name: 'Tiranoc Chariot', points: 60, group: 'mount', isFixedCost:true, addsCrew:2, addsMounts:2,
        optionProfile: [{name:'Warrior', stats: HE_STATS.elvenWarrior},{ name: 'Elven Steed', stats: HE_STATS.elvenSteed },{ name: 'Heavy chariot', stats: HE_STATS.heavyChariot }], category:'mount', },
      { id: 'scythed', name: 'Scythed wheels', points: 20, isFixedCost: true, requires:['Tiranoc_chariot'] },
      ...
      { id: 'lion_barding', name: 'White Lions Barding', points: 5, isFixedCost: true, requires:['whitelion_chariot'] },
      { id: 'additional_lion_mounts', name: 'additional White Lions', points: 17, addsMounts:1, maxPerUnit: 2, requires:['whitelion_chariot'] },
      { id: 'pegasus', name: 'Pegasus', points: 54, group: 'mount', optionProfile: [{ name: 'Pegasus', stats: HE_STATS.pegasus }], category:'mount', isFixedCost:true },
      { id: 'great_eagle', name: 'Great Eagle', points: 62, group: 'mount', optionProfile: [{ name: 'Great Eagle', stats: HE_STATS.greatEagle }], category:'mount', isFixedCost:true },
      { id: 'griffon', name: 'Griffon', points: 174, group: 'mount', optionProfile: [{ name: 'Griffon', stats: HE_STATS.griffon }], category:'mount', isFixedCost:true },
      { id: 'dragon', name: 'Dragon', points: 314, group: 'mount', optionProfile: [{ name: 'Dragon', stats: HE_STATS.dragon }], category:'mount', isFixedCost:true },
  ...
  },
  {
    ...
    specialRules: ['Elven stoicism'],
    options: [
      { id: 'steed', name: 'Elven Steed', points: 13, group: 'mount', optionProfile: [{ name: 'Elven Steed', stats: HE_STATS.elvenSteed }], category:'mount', isFixedCost:true },
      { id: 'barding', name: 'Barding', points: 0, requires: ['steed'], category:'mount', isFixedCost:true },
      { id: 'Tiranoc_chariot', name: 'Tiranoc Chariot', points: 60, group: 'mount', isFixedCost:true, addsCrew:2, addsMounts:2,
        optionProfile: [{name:'Warrior', stats: HE_STATS.elvenWarrior},{ name: 'Elven Steed', stats: HE_STATS.elvenSteed },{ name: 'Heavy chariot', stats: HE_STATS.heavyChariot }], category:'mount', },
      { id: 'scythed', name: 'Scythed wheels', points: 20, isFixedCost: true, requires:['Tiranoc_chariot'] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'high', name: 'High Magic', points: 0, group: 'magic_college', category:'magic', isFixedCost:true },

      { id: 'steed', name: 'Elven Steed', points: 0, group: 'mount', optionProfile: [{ name: 'Elven Steed', stats: HE_STATS.elvenSteed }], category:'mount', isFixedCost:true },
      { id: 'barding', name: 'Barding', points: 0, requires: ['steed'], category:'mount', isFixedCost:true },
      { id: 'Tiranoc_chariot', name: 'Tiranoc Chariot', points: 60, group: 'mount', isFixedCost:true, addsCrew:2, addsMounts:2,
        optionProfile: [{name:'Warrior', stats: HE_STATS.elvenWarrior},{ name: 'Elven Steed', stats: HE_STATS.elvenSteed },{ name: 'Heavy chariot', stats: HE_STATS.heavyChariot }], category:'mount', },
      { id: 'scythed', name: 'Scythed wheels', points: 20, isFixedCost: true, requires:['Tiranoc_chariot'] },
      ...
      { id: 'lion_barding', name: 'White Lions Barding', points: 5, isFixedCost: true, requires:['whitelion_chariot'] },
      { id: 'additional_lion_mounts', name: 'additional White Lions', points: 17, addsMounts:1, maxPerUnit: 2, requires:['whitelion_chariot'] },
      { id: 'unicorn', name: 'Unicorn', points: 30, group: 'mount', optionProfile: [{ name: 'Unicorn', stats: HE_STATS.unicorn }], category:'mount', isFixedCost:true },
      { id: 'pegasus', name: 'Pegasus', points: 40, group: 'mount', optionProfile: [{ name: 'Pegasus', stats: HE_STATS.pegasus }], category:'mount', isFixedCost:true },
      { id: 'great_eagle', name: 'Great Eagle', points: 48, group: 'mount', optionProfile: [{ name: 'Great Eagle', stats: HE_STATS.greatEagle }], category:'mount', isFixedCost:true },
      { id: 'griffon', name: 'Griffon', points: 160, group: 'mount', optionProfile: [{ name: 'Griffon', stats: HE_STATS.griffon }], category:'mount', isFixedCost:true },
      { id: 'dragon', name: 'Dragon', points: 300, group: 'mount', optionProfile: [{ name: 'Dragon', stats: HE_STATS.dragon }], category:'mount', isFixedCost:true },
      { id: 'great_dragon', name: 'Great Dragon', points: 425, group: 'mount', optionProfile: [{ name: 'Great Dragon', stats: HE_STATS.greatDragon }], category:'mount', isFixedCost:true },
    ]
  },
  {
    id: 'master_mage',
