...
export const characters: UnitDefinition[] = [
  {
    ...
    options: [
      ...
      { id: 'lion_mounts', name: 'White Lions', points: 20, isFixedCost: true, requires:['Tiranoc_chariot'], optionProfile:[{name:'White Lion', stats:HE_STATS.whiteLion}] },
      { id: 'lion_barding', name: 'White Lions Barding', points: 5, isFixedCost: true, requires:['Tiranoc_chariot', 'lion_mounts'] },
      { id: 'additional_lion_mounts', name: 'additional White Lions', points: 17, isFixedCost: true,maxPerUnit: 2, requires:['Tiranoc_chariot', 'lion_mounts'], conflicts:['additional_steed'] },
      {
        id: 'additional_steed',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'Tiranoc_chariot', name: 'Tiranoc Chariot', points: 60, group: 'mount', 
        optionProfile: [{name:'Warrior', stats: HE_STATS.elvenWarrior},{ name: 'Elven Steed', stats: HE_STATS.elvenSteed },{ name: 'Heavy chariot', stats: HE_STATS.heavyChariot }], category:'mount' },
      { id: 'scythed', name: 'Scythed wheels', points: 20, isFixedCost: true, requires:['Tiranoc_chariot'] },
      {
        id: 'additional_elf_crew',
